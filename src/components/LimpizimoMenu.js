...
function LimpizimoMenu() {
    ...
    const modalinfo = [
        ...
        { title: 'Limpipuntos', type: 'listItem', icon: 'coins', iconType: 'font-awesome-5', routeKey: 'LimpiPoint' },
        ...
        >
            ...
            >
                <View style={{ marginLeft: 10, }}>
                    <ImageUserProfile isVerified={false} imageUrl='https://www.diethelmtravel.com/wp-content/uploads/2016/04/bill-gates-wealthiest-person.jpg' size={96} fullRounded={true} borderThickness={2} outlineColor={colors.secondaryColor} />
                </View>

                <View style={{ flexDirection: 'column', paddingLeft: 10 }}>
                    <Text style={{ color: '#73BF43', fontWeight: 'bold', fontSize: 22 }}>{user?.name}</Text>
                    <View style={{ display: 'flex', flexDirection: 'row', alignItems: 'center', justifyContent: 'flex-start' }}>
                        <Text style={{ color: colors.greyText2, fontWeight: 'bold', fontSize: 16 }}>(5</Text>
                        <Icon
                            size={16}
                            name="star"
                            type="ionicon"
                        ...
                        />
                        <Text style={{ color: colors.greyText2, fontWeight: 'bold', fontSize: 14 }}>)</Text>
                    </View>
                    <Text style={{ color: colors.greyText2, fontSize: 16, marginTop: 5 }}>Editar perfil</Text>
                </View>
            </View>
            ...
            <TouchableOpacity>
                <View style={styles.listMainTitleContainer}>
                    <View style={styles.utilityRow}>
                        ...
                        <Text style={[styles.listMainTitleText, { marginLeft: 10 }]}>100</Text>
                    </View>
                    <Icon
                        size={32}
                        name='chevron-right'
            ...
            <FlatList
                ...
                renderItem={({ item }) => (
                    item.type === 'listItem' ? (
                        ...
                        <View style={[styles.menuItem, item.title === 'Información' ? styles.listTitleContainerTertiary : styles.listTitleContainer]}>
