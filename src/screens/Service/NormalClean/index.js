    ...
    return (
        <ScrollView>
            <View style={styles.container}>
                ...
                <Image
                    style={{ height: 70, width: 50, tintColor: '#fff', marginBottom: 5 }}
                    source={require('../../../assets/images/Global/normalCleaning.png')}
                    resizeMode="contain" />
                <Text style={{ color: 'white', alignSelf: 'center', fontWeight: 'bold', fontSize: 24 }}>LIMPIEZA NORMAL</Text>
